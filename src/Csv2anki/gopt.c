...
options_t process_options(int argc, char **argv)
{
  ...
  "\tseparator list.\n"
  "\tIf the end use of the output is to be input to be Anki the use\n"
  "\tof ';' as a separator and also ' ' may be used to concatenate 2\n"
  "\t fields into one. Output separators may be multi character, eg\n"
  "\t'<br />' if required. The only output separator not permitted\n"
  "\tbut see the examples in the man page for more detail about this.\n"
  ...
  "\tOPTIONS\n"
  "\t\t-h, --help\n\n"
  "\tPrints this help message and then quits.\n\n"
  "\t-q, --quote\n"
  "\t\tPreserve double quote protection wrapped around input fields to\n"
  "\t\tprotect embedded commas. By default this protection is removed\n"
  "\t\ton the assumption that the output separator will be something\n"
  "\t\tlike ';'.\n"
  ;

	optstring = ":hq";	// initialise
